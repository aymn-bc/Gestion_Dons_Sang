...
<body class="bg-slate-50 flex justify-center items-center mt-auto mb-auto h-[100vh]">
    <form method="POST" action="submit" class="border-2 p-5 m-2 w-1/3 bg-white text-center rounded-xl border-black">
        ...
        <input type="button" value="S'inscrire" class="border-2 border-gray-300 hover:bg-gray-300 p-2 w-full text-gray-600 font-bold transition ease-in-out duration-500 hover:cursor-pointer rounded-full" >
    </form>
</body>
</html>